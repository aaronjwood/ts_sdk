/**
 * \file timer_stm32f4.h
 * \copyright Copyright (c) 2017 Verizon. All rights reserved.
 * \brief Defines the generic interface for the stm32f4 family timer peripheral.
...
#ifndef TIMER_STM32F4_INTERFACE_H
#define TIMER_STM32F4_INTERFACE_H

#include "timer_hal.h"

/**
 * \brief Type that defines timers ids for stm32f4 family, There are total 14
 * timers available for stm32f429zi chipset
 */
...
/**
 * \brief Retrieve the interface of the stm32f4 timer.
 * \param[in] timer id
 * \returns Pointer to timer tim's interface or NULL if fails
 */
