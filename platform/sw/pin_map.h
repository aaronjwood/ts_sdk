 ...
 * board combination. Each entry is of type \ref pin_map_t and has all the information
 ...
 */
extern const pin_map_t uart_tx_map[];

/**
 * \brief UART RX pin mappings
 */
extern const pin_map_t uart_rx_map[];

/**
 * \brief UART RTS pin mappings
 */
extern const pin_map_t uart_rts_map[];

/**
 * \brief UART CTS pin mappings
 */
extern const pin_map_t uart_cts_map[];

/**
 * \brief I2C SDA pin mappings
 */
extern const pin_map_t i2c_sda_map[];

/**
 * \brief I2C SCL pin mappings
 */
extern const pin_map_t i2c_scl_map[];
