...
CFLAGS_COM += -Werror -std=c99 $(INC) $(APP_CFLAGS) -D$(PROTOCOL) -D$(MODEM) -D$(DEV_BOARD) $(DEF_FLAG_MCU)
...
ifneq ($(REMOTE_HOST),)
ifneq ($(SSL_HOST),)
CFLAGS_COM = -DSSL_HOST='$(SSL_HOST)' -DREMOTE_HOST='$(REMOTE_HOST)'
else
CFLAGS_COM = -DREMOTE_HOST='$(REMOTE_HOST)'
endif
endif
