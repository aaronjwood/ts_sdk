...
const pin_t uart_tx_map[] = {
	...
	{PC10, DEFAULT_UART_PIN_CONF, AF8, (uintptr_t)UART4},
	{PC10, DEFAULT_UART_PIN_CONF, AF7, (uintptr_t)USART3},
	{PC12, DEFAULT_UART_PIN_CONF, AF8, (uintptr_t)UART5},
	{PD5, DEFAULT_UART_PIN_CONF, AF7, (uintptr_t)USART2},
	{PD8, DEFAULT_UART_PIN_CONF, AF7, (uintptr_t)USART3},
	{PE1, DEFAULT_UART_PIN_CONF, AF8, (uintptr_t)UART8},
	{PE8, DEFAULT_UART_PIN_CONF, AF8, (uintptr_t)UART7},
	{PF7, DEFAULT_UART_PIN_CONF, AF8, (uintptr_t)UART7},
	{PG14, DEFAULT_UART_PIN_CONF, AF8, (uintptr_t)USART6},
	END_OF_MAP
};
...
const pin_t uart_rx_map[] = {
	...
	{PC11, DEFAULT_UART_PIN_CONF, AF7, (uintptr_t)USART3},
	{PD2, DEFAULT_UART_PIN_CONF, AF8, (uintptr_t)UART5},
	{PD6, DEFAULT_UART_PIN_CONF, AF7, (uintptr_t)USART2},
	{PD9, DEFAULT_UART_PIN_CONF, AF7, (uintptr_t)USART3},
	{PE0, DEFAULT_UART_PIN_CONF, AF8, (uintptr_t)UART8},
	{PE7, DEFAULT_UART_PIN_CONF, AF8, (uintptr_t)UART7},
	{PF6, DEFAULT_UART_PIN_CONF, AF8, (uintptr_t)UART7},
	{PG9, DEFAULT_UART_PIN_CONF, AF6, (uintptr_t)USART6},
	END_OF_MAP
};
...
const pin_t uart_rts_map[] = {
	...
	{PG12, DEFAULT_UART_PIN_CONF, AF8, (uintptr_t)USART6},
	END_OF_MAP
};
...
const pin_t i2c_scl_map[] = {
	{PA8, DEFAULT_I2C_PIN_CONF, AF4, (uintptr_t)I2C3},
